...
enum ONM_EKRAN_LIST
{
  ...
  ONM_EKRAN_MEASURMENT_CURRENT = EKRAN_MEASURMENT_2,
  ONM_EKRAN_MEASURMENT_VOLTAGE_TYPE = EKRAN_MEASURMENT_SELSYN,
  ONM_EKRAN_MEASURMENT_VOLTAGE_PHASE = EKRAN_VOLTAGE_SELSYN,
  ONM_EKRAN_MEASURMENT_VOLTAGE_LINE = EKRAN_ANGLE_SELSYN,
