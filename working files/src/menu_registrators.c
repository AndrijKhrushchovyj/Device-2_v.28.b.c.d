    ...
    for (unsigned int i = 0; i < MAX_ROW_FOR_EKRAN_ANALOG_VALUES_DR; i++)
    {
      if (i < IDM_R_AB)
      {
       //Струми і напруги
        ...
        else if (i < IDM_I04) koef_mul = TCurrent;
        else if (i == IDM_I04) koef_mul = TCurrent04;
...
#undef SIZE_UNDEF
      ...
      else if ((i == IDM_VMP_last_KZ) && (type_view_max_values_dr == IDENTIFIER_BIT_ARRAY_MAX_CURRENT_PHASE))
      {
        //Місце пошкодження
