...
inline void diagnostyka_boards(void)
{
  ...
  else if ((board_register_diff & 0x01) || _CHECK_SET_BIT(diagnostyka_tmp, ERROR_BA_1_CTLR))
  {
    ...
    if ((board_register_diff & 0x02) && ((board_register_tmp & 0x02) != 0x2)) _SET_BIT(set_diagnostyka, ERROR_BDV2_FIX);
  ...
  if ((board_register_diff & 0x04) && ((board_register_tmp & 0x04) !=  0x4)) _SET_BIT(set_diagnostyka, ERROR_BDV5_FIX);
...
//      }
  ...
  if ((board_register_diff & 0x04) && ((board_register_tmp & 0x04) !=  0x4)) _SET_BIT(set_diagnostyka, ERROR_BDVV_DZ_FIX);
  else if ((board_register_diff & 0x04) || _CHECK_SET_BIT(diagnostyka_tmp, ERROR_BDVV_DZ_CTLR))
  {
    ...
    else _SET_BIT(clear_diagnostyka, ERROR_BDVV_DZ_CTLR);
    _DEVICE_REGISTER_V2(Bank1_SRAM2_ADDR, OFFSET_DD39_DD40_DD47) = 0x0;
  }
#endif
