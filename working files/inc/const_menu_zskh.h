...
#define EKRAN_SETPOINT_MTZ04_GROUP1 (EKRAN_SETPOINT_RPN_GROUP4 + 1)
...
#define EKRAN_TIMEOUT_MTZ04_GROUP1 (EKRAN_TIMEOUT_RPN_GROUP4 + 1)
...
#define EKRAN_CONTROL_MTZ04 (EKRAN_CONTROL_RPN + 1)
