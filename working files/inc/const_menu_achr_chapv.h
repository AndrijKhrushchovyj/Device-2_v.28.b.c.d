...
#define EKRAN_SETPOINT_ACHR_CHAPV_GROUP1 (EKRAN_SETPOINT_BRP_GROUP4 + 1)
...
#define EKRAN_TIMEOUT_ACHR_CHAPV_GROUP1 (EKRAN_TIMEOUT_RPN_GROUP4 + 1)
...
#define EKRAN_CONTROL_ACHR_CHAPV (EKRAN_CONTROL_ZNKh + 1)
