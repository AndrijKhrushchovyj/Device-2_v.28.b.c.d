...
#define NUMBER_SIMPLE_OUTPUTS           20
...
#define MASKA_BUTTON_MODE_1_SIGNALS_0 (                        \
  ...
  | (1u << (RANG_SMALL_BLOCK_MTZ04_1 - 0))                     \
  | (1u << (RANG_SMALL_BLOCK_MTZ04_2 - 0))                     \
  | (1u << (RANG_SMALL_BLOCK_USK_MTZ04_2 - 0))                 \
  | (1u << (RANG_SMALL_BLOCK_ZNAM - 0))                        \
  | (1u << (RANG_SMALL_BLOCK_ZDZ - 0))                         \
  | (1u << (RANG_SMALL_BLOCK_NZZ - 0))                         \
  | (1u << (RANG_SMALL_BLOCK_TZNP1 - 0))                       \
  | (1u << (RANG_SMALL_BLOCK_TZNP2 - 0))                       \
  | (1u << (RANG_SMALL_BLOCK_TZNP3 - 0))                       \
  | (1u << (RANG_SMALL_STAT_BLK_APV - 0))                      \
)
...
#define MASKA_FOR_INPUT_SIGNALS_1 (                              \
  ...
  | (1u << (RANG_BLOCK_MTZ4 - 32))                               \
)

#define MASKA_FOR_INPUT_SIGNALS_2 (                             \
    (1u << (RANG_BLOCK_MTZ04_1 - 64))                           \
  | (1u << (RANG_BLOCK_MTZ04_2 - 64))                           \
  | (1u << (RANG_BLOCK_USK_MTZ04_2 - 64))                       \
  | (1u << (RANG_BLOCK_ZNAM - 64))                              \
  | (1u << (RANG_BLOCK_ZDZ - 64))                               \
  | (1u << (RANG_PUSK_ZDZ_VID_DV - 64))                         \
  | (1u << (RANG_BLOCK_NZZ - 64))                               \
)
    
#define MASKA_FOR_INPUT_SIGNALS_3 (                             \
    (1u << (RANG_BLOCK_TZNP1 - 96))                             \
  | (1u << (RANG_BLOCK_TZNP2 - 96))                             \
  | (1u << (RANG_BLOCK_TZNP3 - 96))                             \
  | (1u << (RANG_STAT_BLK_APV - 96))                            \
)
    
#define MASKA_FOR_INPUT_SIGNALS_4 (                            \
    (1u << (RANG_ACHR_CHAPV_VID_DV - 128))                     \
  | (1u << (RANG_BLOCK_ACHR1 - 128))                           \
  | (1u << (RANG_BLOCK_ACHR2 - 128))                           \
  | (1u << (RANG_BLOCK_UROV - 128))                      	     \
  | (1u << (RANG_PUSK_UROV_VID_DV - 128))                      \
  | (1u << (RANG_BLOCK_ZOP - 128))                             \
  | (1u << (RANG_BLOCK_UMIN1 - 128))                           \
  | (1u << (RANG_START_UMIN1 - 128))                           \
  | (1u << (RANG_BLOCK_UMIN2 - 128))                           \
  | (1u << (RANG_START_UMIN2 - 128))                           \
)
    
#define MASKA_FOR_INPUT_SIGNALS_5 (                            \
    (1u << (RANG_BLOCK_UMAX1 - 160))                           \
  | (1u << (RANG_BLOCK_UMAX2 - 160))                           \
  | (1u << (RANG_BLOCK_UP1 + 3*0 - 160))                       \
  | (1u << (RANG_BLOCK_UP1 + 3*1 - 160))                       \
  | (1u << (RANG_BLOCK_UP1 + 3*2 - 160))                       \
  | (1u << (RANG_BLOCK_UP1 + 3*3 - 160))                       \
  | (1u << (RANG_BLOCK_UP1 + 3*4 - 160))                       \
  | (1u << (RANG_BLOCK_UP1 + 3*5 - 160))                       \
  | (1u << (RANG_BLOCK_UP1 + 3*6 - 160))                       \
  | (1u << (RANG_BLOCK_UP1 + 3*7 - 160))                       \
)
...
#define MASKA_FOR_INPUT_SIGNALS_6 (                            \
  ...
  | (1u << (RANG_DF8_R - 192))                                 \
  | (1u << (RANG_DT1_SET - 192))                               \
  | (1u << (RANG_DT1_RESET - 192))                             \
  | (1u << (RANG_DT2_SET - 192))                               \
  | (1u << (RANG_DT2_RESET - 192))                             \
  | (1u << (RANG_DT3_SET - 192))                               \
)
...
#define MASKA_MTZ_SIGNALS_1 (                                  \
   ...
   | (1u << (RANG_BLOCK_MTZ3 - 32))                            \
   | (1u << (RANG_BLOCK_MTZ4 - 32))                            \
   | (1u << (RANG_SECTOR_VPERED_MTZN1 - 32))                   \
   | (1u << (RANG_SECTOR_NAZAD_MTZN1 - 32))                    \
   | (1u << (RANG_PO_MTZ1 - 32))                               \
   | (1u << (RANG_PO_MTZN1_VPERED - 32))                       \
   | (1u << (RANG_PO_MTZN1_NAZAD - 32))                        \
   | (1u << (RANG_PO_U_MTZPN1 - 32))                           \
   | (1u << (RANG_PO_MTZPN1 - 32))                             \
   | (1u << (RANG_MTZ1 - 32))                                  \
   | (1u << (RANG_SECTOR_VPERED_MTZN2 - 32))                   \
   | (1u << (RANG_SECTOR_NAZAD_MTZN2 - 32))                    \
   | (1u << (RANG_PO_MTZ2 - 32))                               \
   | (1u << (RANG_PO_MTZN2_VPERED - 32))                       \
   | (1u << (RANG_PO_MTZN2_NAZAD - 32))                        \
   | (1u << (RANG_PO_U_MTZPN2 - 32))                           \
   | (1u << (RANG_PO_MTZPN2 - 32))                             \
   | (1u << (RANG_MTZ2 - 32))                                  \
   | (1u << (RANG_SECTOR_VPERED_MTZN3 - 32))                   \
   | (1u << (RANG_SECTOR_NAZAD_MTZN3 - 32))                    \
   | (1u << (RANG_PO_MTZ3 - 32))                               \
   | (1u << (RANG_PO_MTZN3_VPERED - 32))                       \
   | (1u << (RANG_PO_MTZN3_NAZAD - 32))                        \
   | (1u << (RANG_PO_U_MTZPN3 - 32))                           \
   | (1u << (RANG_PO_MTZPN3 - 32))                             \
   | (1u << (RANG_MTZ3 - 32))                                  \
   | (1u << (RANG_SECTOR_VPERED_MTZN4 - 32))                   \
)
...
#define MASKA_MTZ04_SIGNALS_2 (                                \
     (1u << (RANG_BLOCK_MTZ04_1 - 64))                         \
   | (1u << (RANG_BLOCK_MTZ04_2 - 64))                         \
   | (1u << (RANG_BLOCK_USK_MTZ04_2 - 64))                     \
   | (1u << (RANG_PO_MTZ04_1 - 64))                            \
   | (1u << (RANG_MTZ04_1 - 64))                               \
   | (1u << (RANG_PO_MTZ04_2 - 64))                            \
   | (1u << (RANG_MTZ04_2 - 64))                               \
)
...
#define MASKA_ZDZ_SIGNALS_2 (                                  \
     (1u << (RANG_BLOCK_ZDZ - 64))                             \
   | (1u << (RANG_PUSK_ZDZ_VID_DV - 64))                       \
   | (1u << (RANG_LIGHT_ZDZ_FROM_DV - 64))                     \
   | (1u << (RANG_PO_ZDZ - 64))                                \
   | (1u << (RANG_ZDZ - 64))                                   \
)
...
#define MASKA_TZNP_SIGNALS_3 (                                 \
   ...
   | (1u << (RANG_PO_3U0_TZNP1_NAZAD - 96))                    \
   | (1u << (RANG_PO_TZNP1_VPERED - 96))                       \
   | (1u << (RANG_PO_TZNP1_NAZAD - 96))                        \
   | (1u << (RANG_TZNP1 - 96))                                 \
   | (1u << (RANG_BLOCK_TZNP2 - 96))                           \
   | (1u << (RANG_SECTOR_TZNP2_VPERED - 96))                   \
   | (1u << (RANG_SECTOR_TZNP2_NAZAD - 96))                    \
   | (1u << (RANG_PO_3I0_TZNP2_VPERED - 96))                   \
   | (1u << (RANG_PO_3I0_TZNP2_NAZAD - 96))                    \
   | (1u << (RANG_PO_3U0_TZNP2_VPERED - 96))                   \
   | (1u << (RANG_PO_3U0_TZNP2_NAZAD - 96))                    \
   | (1u << (RANG_PO_TZNP2_VPERED - 96))                       \
   | (1u << (RANG_PO_TZNP2_NAZAD - 96))                        \
   | (1u << (RANG_TZNP2 - 96))                                 \
   | (1u << (RANG_BLOCK_TZNP3 - 96))                           \
   | (1u << (RANG_SECTOR_TZNP3_VPERED - 96))                   \
   | (1u << (RANG_SECTOR_TZNP3_NAZAD - 96))                    \
   | (1u << (RANG_PO_3I0_TZNP3_VPERED - 96))                   \
   | (1u << (RANG_PO_3I0_TZNP3_NAZAD - 96))                    \
   | (1u << (RANG_PO_3U0_TZNP3_VPERED - 96))                   \
   | (1u << (RANG_PO_3U0_TZNP3_NAZAD - 96))                    \
   | (1u << (RANG_PO_TZNP3_VPERED - 96))                       \
   | (1u << (RANG_PO_TZNP3_NAZAD - 96))                        \
   | (1u << (RANG_TZNP3 - 96))                                 \
)
...
#define MASKA_ACHR_CHAPV_SIGNALS_4 (                           \
   ...
   | (1u << (RANG_BLOCK_ACHR1 - 128))                          \
   | (1u << (RANG_BLOCK_ACHR2 - 128))                          \
   | (1u << (RANG_RAZR_CHAPV - 128))                           \
   | (1u << (RANG_VN_BLOCK_CHAPV - 128))                       \
   | (1u << (RANG_PO_ACHR1 - 128))                             \
   | (1u << (RANG_PO_CHAPV1 - 128))                            \
   | (1u << (RANG_ACHR_CHAPV1 - 128))                          \
   | (1u << (RANG_PO_ACHR2 - 128))                             \
   | (1u << (RANG_PO_CHAPV2 - 128))                            \
   | (1u << (RANG_ACHR_CHAPV2 - 128))                          \
)
...
#define MASKA_UMIN_SIGNALS_4 (                                 \
     (1u << (RANG_BLOCK_UMIN1 - 128))                          \
   | (1u << (RANG_START_UMIN1 - 128))                          \
   | (1u << (RANG_BLOCK_UMIN2 - 128))                          \
   | (1u << (RANG_START_UMIN2 - 128))                          \
   | (1u << (RANG_PO_UMIN1 - 128))                             \
   | (1u << (RANG_PO_UBLK_UMIN1 - 128))                        \
   | (1u << (RANG_PO_IBLK_UMIN1 - 128))                        \
   | (1u << (RANG_UMIN1 - 128))                                \
   | (1u << (RANG_PO_UMIN2 - 128))                             \
)
...
#define MASKA_UP_SIGNALS_5 (                                 \
     (1u << (RANG_BLOCK_UP1 + 3*0 - 160))                    \
   | (1u << (RANG_PO_UP1 + 3*0 - 160))                       \
   | (1u << (RANG_UP1 + 3*0 - 160))                          \
   | (1u << (RANG_BLOCK_UP1 + 3*1 - 160))                    \
   | (1u << (RANG_PO_UP1 + 3*1 - 160))                       \
   | (1u << (RANG_UP1 + 3*1 - 160))                          \
   | (1u << (RANG_BLOCK_UP1 + 3*2 - 160))                    \
   | (1u << (RANG_PO_UP1 + 3*2 - 160))                       \
   | (1u << (RANG_UP1 + 3*2 - 160))                          \
   | (1u << (RANG_BLOCK_UP1 + 3*3 - 160))                    \
   | (1u << (RANG_PO_UP1 + 3*3 - 160))                       \
   | (1u << (RANG_UP1 + 3*3 - 160))                          \
   | (1u << (RANG_BLOCK_UP1 + 3*4 - 160))                    \
   | (1u << (RANG_PO_UP1 + 3*4 - 160))                       \
   | (1u << (RANG_UP1 + 3*4 - 160))                          \
   | (1u << (RANG_BLOCK_UP1 + 3*5 - 160))                    \
   | (1u << (RANG_PO_UP1 + 3*5 - 160))                       \
   | (1u << (RANG_UP1 + 3*5 - 160))                          \
   | (1u << (RANG_BLOCK_UP1 + 3*6 - 160))                    \
   | (1u << (RANG_PO_UP1 + 3*6 - 160))                       \
   | (1u << (RANG_UP1 + 3*6 - 160))                          \
   | (1u << (RANG_BLOCK_UP1 + 3*7 - 160))                    \
   | (1u << (RANG_PO_UP1 + 3*7 - 160))                       \
)
...
#define MASKA_TRIGGER_SIGNALES_6 (                             \
     (1u << (RANG_DT1_OUT - 192))                              \
   | (1u << (RANG_DT2_OUT - 192))                              \
)     
...
#define MASKA_MONITOTYNG_PHASE04_SIGNALES_2 (                  \
     (1u << (RANG_PO_MTZ04_1 - 64))                            \
   | (1u << (RANG_MTZ04_1 - 64))                               \
   | (1u << (RANG_PO_MTZ04_2 - 64))                            \
   | (1u << (RANG_MTZ04_2 - 64))                               \
...
#define MASKA_MONITOTYNG_ZNAM_SIGNALES_2 (                  \
     (1u << (RANG_PO_ZNAM - 64))                            \
   | (1u << (RANG_ZNAM - 64))                               \
)
...
#define MASKA_MONITOTYNG_3I0_1G_SIGNALES_2 (                   \
     (1u << (RANG_PO_NZZ - 64))                                \
   | (1u << (RANG_NZZ - 64))                                   \
   | (1u << (RANG_PO_3I0 - 64))                                \
   | (1u << (RANG_3I0 - 64))                                   \
...
#define MASKA_MONITOTYNG_3I0_OTHERG_SIGNALES_2 (               \
     (1u << (RANG_PO_3I0 - 64))                                \
   | (1u << (RANG_3I0 - 64))                                   \
)    
...
#define MASKA_MONITOTYNG_3I0_R_SIGNALES_3 (                    \
     (1u << (RANG_PO_TZNP1_VPERED - 96))                       \
   | (1u << (RANG_PO_TZNP1_NAZAD - 96))                        \
   | (1u << (RANG_TZNP1 - 96))                                 \
   | (1u << (RANG_PO_TZNP2_VPERED - 96))                       \
...
#define MASKA_MONITOTYNG_3U0_SIGNALES_2 (                      \
     (1u << (RANG_PO_NZZ - 64))                                \
   | (1u << (RANG_NZZ - 64))                                   \
   | (1u << (RANG_PO_3U0 - 64))                                \
   | (1u << (RANG_3U0 - 64))                                   \
...
#define MASKA_MONITOTYNG_UMIN_SIGNALES_4 (                     \
     (1u << (RANG_PO_UMIN1 - 128))                             \
   | (1u << (RANG_UMIN1 - 128))                                \
   | (1u << (RANG_PO_UMIN2 - 128))                             \
)
...
#define MASKA_MONITOTYNG_ZOP_SIGNALES_4 (                      \
     (1u << (RANG_PO_ZOP - 128))                               \
   | (1u << (RANG_ZOP - 128))                                  \
)
...
#define MASKA_MONITOTYNG_F_MIN_ACHR_SIGNALES_4 (                 \
     (1u << (RANG_PO_ACHR1 - 128))                               \
   | (1u << (RANG_ACHR_CHAPV1 - 128))                            \
   | (1u << (RANG_PO_ACHR2 - 128))                               \
   | (1u << (RANG_ACHR_CHAPV2 - 128))                            \
