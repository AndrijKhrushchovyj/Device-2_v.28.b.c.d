...
#define MAX_ROW_FOR_EKRAN_ANALOG_VALUES_DR (SIZE_ARRAY_FIX_MAX_MEASUREMENTS - 1)
...
enum _index_title_dr
{
  ...
  INDEX_ML_TITLE_DR_MAX_U_BASE,
  INDEX_ML_TITLE_DR_MAX_U_SECOND,
  INDEX_ML_TITLE_DR_MIN_U_BASE,
  INDEX_ML_TITLE_DR_MAX_I_BASE,
