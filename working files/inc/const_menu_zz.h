...
#define EKRAN_SETPOINT_ZZ_GROUP1 (EKRAN_SETPOINT_BRP_GROUP4 + 1)
...
#define EKRAN_TIMEOUT_ZZ_GROUP1 (EKRAN_TIMEOUT_RPN_GROUP4 + 1)
...
#define EKRAN_CONTROL_ZZ (EKRAN_CONTROL_ZNKh + 1)
