...
#define NUMBER_INPUTS                   13
#define NUMBER_SIMPLE_OUTPUTS           12
#define NUMBER_DS                       1
...
#define MASKA_ZDZ_SIGNALS_2 (                                  \
   ...
   | (1u << (RANG_LIGHT_ZDZ_FROM_OVD1 - 64))                   \
   | (1u << (RANG_LIGHT_ZDZ_FROM_OVD2 - 64))                   \
   | (1u << (RANG_LIGHT_ZDZ_FROM_OVD3 - 64))                   \
   | (1u << (RANG_PO_ZDZ - 64))                                \
   | (1u << (RANG_ZDZ - 64))                                   \
)
...
/*****************************************/
#define VERSIA_PZ                                             14
#define MODYFIKACIA_VERSII_PZ                                 7
