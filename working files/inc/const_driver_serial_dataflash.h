...
enum _index_meas_dr
{
  ...
  IDM_freq_1 = _SIZE_ARRAY_FIX_MAX_MEASUREMENTS_TMP,
  IDM_freq_2,
  IDM_STEP,
  IDM_CONTROL,
  IDM_TM_STAMPE,
...
#define MAX_NUMBER_FIX_MAX_MEASUREMENTS 8

#define FIRST_INDEX_START_START_RECORD_DR 0
#define FIRST_INDEX_DATA_TIME_DR 1
#define FIRST_INDEX_NAME_OF_CELL_DR 13
#define FIRST_INDEX_TC1 45
#define FIRST_INDEX_TC2 49
#define FIRST_INDEX_TV1 53
#define FIRST_INDEX_TV2 57
#define FIRST_INDEX_SOURCE_DR 61
#define FIRST_INDEX_NUMBER_BEFORE_ITEMS_DR (61 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_ITEMS_DR (62 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_CHANGES_DR (63 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_U_BASE_DR (65 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_U_SECOND_DR (66 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MIN_U_BASE_DR (67 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_I_BASE_DR (68 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_FIRST_BLOCK_DR (69 + NUMBER_BYTES_SAMPLE_DR)
...
{
  IDENTIFIER_BIT_ARRAY_MAX_U_BASE = 1,
  IDENTIFIER_BIT_ARRAY_MAX_U_SECOND,
  IDENTIFIER_BIT_ARRAY_MIN_U_BASE,
  IDENTIFIER_BIT_ARRAY_MAX_I_BASE,

  _NUMBER_IDENTIFIER = IDENTIFIER_BIT_ARRAY_MAX_I_BASE
};
...
#define AR_NUMBER_ANALOG_CANALES (_NUMBER_ANALOG_CANALES_AR + 2)
#define AR_TOTAL_NUMBER_CANALES (AR_NUMBER_ANALOG_CANALES)
