...
#define FIRST_INDEX_NUMBER_MIN_U_DR (69 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_U_DR (70 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_ZOP_DR (71 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MIN_F_ACHR_DR (72 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_F_CHAPV_DR (73 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_FIRST_BLOCK_DR (74 + NUMBER_BYTES_SAMPLE_DR)
...
{
  IDENTIFIER_BIT_ARRAY_MIN_VOLTAGE = 1,
  IDENTIFIER_BIT_ARRAY_MAX_VOLTAGE,

  _NUMBER_IDENTIFIER = IDENTIFIER_BIT_ARRAY_MAX_VOLTAGE
};
