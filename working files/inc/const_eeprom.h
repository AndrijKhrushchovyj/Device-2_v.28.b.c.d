...
#define START_ADDRESS_ANGLE_IN_EEPROM                   (((START_ADDRESS_INFO_REJESTRATORS_AR         + (sizeof(info_rejestrator_ar)                                   + 1)) & (unsigned int)(~(SIZE_PAGE_EEPROM - 1))) + SIZE_PAGE_EEPROM)
#define START_ADDRESS_RESURS_IN_EEPROM                  (((START_ADDRESS_ANGLE_IN_EEPROM              + (sizeof(unsigned int)*2                                        + 1)) & (unsigned int)(~(SIZE_PAGE_EEPROM - 1))) + SIZE_PAGE_EEPROM)
// clang-format on
...
#define COMPARISON_WRITING_ANGLE_BIT 7
#define COMPARISON_WRITING_ANGLE (1 << COMPARISON_WRITING_ANGLE_BIT)
#define COMPARISON_WRITING_RESURS_BIT 8
...
#define TASK_START_WRITE_ANGLE_EEPROM_BIT 29
#define TASK_WRITING_ANGLE_EEPROM_BIT 30

#define TASK_START_READ_ANGLE_EEPROM_BIT 31
#define TASK_READING_ANGLE_EEPROM_BIT 32

#define TASK_START_WRITE_RESURS_EEPROM_BIT 33
#define TASK_WRITING_RESURS_EEPROM_BIT 34

#define TASK_START_READ_RESURS_EEPROM_BIT 35
#define TASK_READING_RESURS_EEPROM_BIT 36
...
#define STATE_ANGLE_EEPROM_EMPTY_BIT 23
#define STATE_ANGLE_EEPROM_EMPTY (1 << STATE_ANGLE_EEPROM_EMPTY_BIT)
#define STATE_ANGLE_EEPROM_FAIL_BIT 24
#define STATE_ANGLE_EEPROM_FAIL (1 << STATE_ANGLE_EEPROM_FAIL_BIT)
#define STATE_ANGLE_EEPROM_GOOD_BIT 25
#define STATE_ANGLE_EEPROM_GOOD (1 << STATE_ANGLE_EEPROM_GOOD_BIT)

#define STATE_RESURS_EEPROM_EMPTY_BIT 26
#define STATE_RESURS_EEPROM_EMPTY (1 << STATE_RESURS_EEPROM_EMPTY_BIT)
#define STATE_RESURS_EEPROM_FAIL_BIT 27
#define STATE_RESURS_EEPROM_FAIL (1 << STATE_RESURS_EEPROM_FAIL_BIT)
#define STATE_RESURS_EEPROM_GOOD_BIT 28
