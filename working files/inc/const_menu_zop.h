...
#define EKRAN_SETPOINT_ZOP_GROUP1 (EKRAN_SETPOINT_BRP_GROUP4 + 1)
...
#define EKRAN_TIMEOUT_ZOP_GROUP1 (EKRAN_TIMEOUT_RPN_GROUP4 + 1)
...
#define EKRAN_CONTROL_ZOP (EKRAN_CONTROL_ZNKh + 1)
